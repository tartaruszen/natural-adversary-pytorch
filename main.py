...
def main(config):
    ...
    # Data loader.
    train_loader, test_loader = get_loader(config.dataset, config.batch_size)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_dim', type=int, default=1, help='dimension of images')
